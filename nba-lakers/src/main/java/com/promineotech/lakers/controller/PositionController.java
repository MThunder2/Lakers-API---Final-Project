...
@OpenAPIDefinition(info = @Info(title = "Positions"), servers = {
	...
	//@formatter:off
	  @Operation(
	      ...
	      responses = {
	          @ApiResponse(
	              responseCode = "200", 
	              description = "A list of positions is returned.", 
	              content = @Content(
	                  mediaType = "application/json", 
	              schema = @Schema(implementation = Positions.class))),
	          @ApiResponse(
	              responseCode = "400", 
	          ...
	          @ApiResponse(
	              responseCode = "404", 
	              description = "No positions were found with the input criteria.", 
	              content = @Content(
	                  mediaType = "application/json")),
	          @ApiResponse(
	              responseCode = "500", 
	  ...
	  List<Positions> fetchPositions(
	     );

	  
	  // @formatter:off
	  @Operation( 
	      summary = "Return a position",
	      description = "Returns a position given the positionPk and position id",
	      responses = {
	          @ApiResponse(
	              responseCode = "200",
	  ...
	  @Operation(
	      ...
	      description = "Returns the created Plaer",
	      responses = {
	          @ApiResponse(
	              responseCode = "201",
	      ...
	      parameters = {
	          ...
	          @Parameter(name = "lastName", 
	          	  allowEmptyValue = false, 
	          	  required = false, 
	          	  description = "The plaers last name"),
